...
//     this.expandedHeaderPadding = _kPanelHeaderExpandedDefaultPadding,
//     this.dividerColor,
//     this.allowOnlyOnePanelOpen = true,
//     this.elevation = 2,
//   })  : assert(children != null),
//         assert(animationDuration != null),
//         _allowOnlyOnePanelOpen = allowOnlyOnePanelOpen,
//         super(key: key);
...
//       final Widget iconHeader = widget.children[index].iconHeader;
//       final Color colorIcon = widget.children[index].colorIcon;
...
//               color: colorIcon,
//               expandedColor: colorIcon,
//               disabledColor: colorIcon,
